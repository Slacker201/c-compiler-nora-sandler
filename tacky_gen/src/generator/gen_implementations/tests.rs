...
use parser::Parse;
use slk_c_core::{
    parser_core::parser_ir::{Function, Statement},
    tacky_core::{Label, TackyInstruction, Value, VariableId},
};
...
fn statement_correct_three_token_expr() {
    ...
    let desired_tacky = vec![
        TackyInstruction::LoadVariable(VariableId::Variable { id: 0 }, Value::I32(0)),
        TackyInstruction::Negate(
            VariableId::Variable { id: 1 },
            VariableId::Variable { id: 0 },
        ),
        TackyInstruction::BitwiseNegate(
